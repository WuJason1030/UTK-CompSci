...
int main()
{
    ...
    *ip = 42;   // deferencing the pointer 'ip' this also changes i to 42.
     //cout << i << endl;
    ...
    *ip  = 200;
    ...
    via a pointer. Here's an example with an int. (can assess only with a pointer)
    */
    ...
    */
    ...
    //for it it to work add
    // pointer2 = new int; // This allocate memory for the nameless integer
    // cout << "Another int: ";
    // cin >> *pointer2;
